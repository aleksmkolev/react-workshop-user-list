 ...
 */
export default function UserListItem({user, onUserInfoClick, onUserDeleteClick, onUserEditClick}) {
    ...
    return (
        <tr>
              ...
              <td>{fromIsoDate(user.updatedAt)}</td>
              <td>{user._id}</td>
              ...
              <td className="actions">
                ...
                <button className="btn info-btn" title="Info" onClick={() => onUserInfoClick(user._id)}>
